...
- 🗃️ **The Stash:** Another way to make space - park any open tab in your Stash and it closes to free a slot. Restore it later from the popup. Turn on Cloud Sync (below) to reach your Stash from any device you're signed into.
- ☁️ **Cloud Sync:** Optionally sync your settings, domain lists, and Stashed tabs across all your signed-in browsers. Off by default - enable it in the settings page.
